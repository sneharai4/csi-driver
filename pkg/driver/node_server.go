...
func (driver *Driver) NodeStageVolume(ctx context.Context, request *csi.NodeStageVolumeRequest) (*csi.NodeStageVolumeResponse, error) {
	log.Infof(">>>>> NodeStageVolume, VolumeId: %s, stagingTargetPath: %s", request.VolumeId, request.StagingTargetPath)
	defer log.Infof("<<<<< NodeStageVolume, VolumeId: %s, stagingTargetPath: %s", request.VolumeId, request.StagingTargetPath)
...
func (driver *Driver) NodeUnstageVolume(ctx context.Context, request *csi.NodeUnstageVolumeRequest) (*csi.NodeUnstageVolumeResponse, error) {
	log.Infof(">>>>> NodeUnstageVolume, VolumeId: %s, stagingTargetPath: %s", request.VolumeId, request.StagingTargetPath)
	defer log.Infof("<<<<< NodeUnstageVolume, VolumeId: %s, stagingTargetPath: %s", request.VolumeId, request.StagingTargetPath)
